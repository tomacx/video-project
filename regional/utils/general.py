...
from regional.utils.google_utils import gsutil_getsize
from regional.utils.metrics import fitness
from regional.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(f='weights/bestfire.pt', s=''):  # from utils.general import *; strip_optimizer()
