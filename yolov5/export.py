...
def export_openvino(file, metadata, half, int8, data, prefix=colorstr("OpenVINO:")):
    ...
    if int8:
        ...
        def gen_dataloader(yaml_path, task="train", imgsz=640, workers=4):
            """Generates a DataLoader for model training or validation based on the given YAML fire configuration."""
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/coco128.yaml", help="fire.yaml path")
